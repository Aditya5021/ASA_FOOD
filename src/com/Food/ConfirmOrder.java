...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
{
		...
		try
		{	
			  String query = "delete FROM cart where qtyno<=0 or qtyno>50 ";
			...
			//Calculating total
				sql ="SELECT sum(m.item_price * c.qtyno) as value FROM menu m,cart c WHERE m.item_id=c.item_id and"
				...
				sql="INSERT INTO items_ordered(order_id,item_id,item_qty)"
						+"SELECT c.order_id, ca.item_id,ca.qtyno FROM orders c,cart ca where "
